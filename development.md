...
This document covers development setup, testing, and contribution guidelines for Topo-Tessellate.
...
See `configs/template.yaml` for a fully documented configuration example with all available options.
